...
export class AddUserComponent {
    ...
    newUserForm!: FormGroup<{ first_name: FormControl<string | null>; last_name: FormControl<string | null>; contact: FormControl<string | null>; email: FormControl<string | null>; password: FormControl<string | null>; password_confirmation: FormControl<string | null>; type: FormControl<string | null>; position: FormControl<string | null>; college: FormControl<string | null>; }>;
